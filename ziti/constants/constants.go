...
const (
	...
	CtrlMgmtAddressVarName                           = "ZITI_CTRL_MGMT_ADDRESS"
	CtrlMgmtAddressVarDescription                    = "The hostname for the controller's management plane"
	...
	CtrlWebInterfaceAddressVarName                   = "ZITI_CTRL_WEB_INTERFACE_ADDRESS"
	CtrlWebInterfaceAddressVarDescription            = "The interface hostname to bind the controller's web listener to"
	...
	CtrlWebAdvertisedAddressVarName                  = "ZITI_CTRL_WEB_ADVERTISED_ADDRESS"
	CtrlWebAdvertisedAddressVarDescription           = "The publicly addressable controller hostname value"
